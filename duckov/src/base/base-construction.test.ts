import { BaseConstruction } from './index';
import { Base, Player } from '../shared/types';

describe('BaseConstruction', () => {
  let base: Base;
  let player: Player;
  let baseConstruction: BaseConstruction;
  ...
  beforeEach(() => {
    ...
    baseConstruction = new BaseConstruction(base, player);
  });
