...
class GrowthLayer {
    ...
    trainStats(statType, amount) {
        ...
        console.log(`训练 ${statType} 增加 ${amount}，当前值: ${this.player.stats[statType]}`);
        return true;
    }
