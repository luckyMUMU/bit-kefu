...
│   │   ├── perk-system/       # Perk技能树
│   │   ├── body-training/     # 身体训练
│   │   ├── blueprint-research/ # 蓝图研究
│   │   └── equipment-modification/ # 装备改装
│   ├── risk/                  # 风险层模块
│   │   ├── time-system/       # 时间奖励/惩罚
│   │   ├── death-mechanism/   # 死亡机制
│   │   ├── secondary-risk/    # 二次风险
│   │   └── safety-slot/       # 安全槽
│   ├── base/                  # 基地建设模块
│   │   ├── workbench/         # 工作台
│   │   ├── research-station/  # 蓝图研究站
│   │   ├── medical-station/   # 医疗站
│   │   ├── armory/            # 军备室
│   │   ├── gym/               # 健身房
│   │   └── storage-locker/    # 储物柜
...
│   │   ├── enemy-design/      # 敌人设计
│   │   └── terrain-utilization/ # 地形利用
│   ├── economy/               # 经济模块
│   │   ├── resource-allocation/ # 物资分配
│   │   ├── trading-system/    # 交易系统
│   │   ├── crafting-system/   # 制造系统
│   │   └── upgrade-system/    # 升级系统
│   ├── lightweight/           # 轻量化设计模块
│   │   ├── top-down-control/  # 俯视角控制
│   │   ├── simplified-inventory/ # 简化背包管理
│   │   ├── pve-only/          # 纯PVE设计
│   │   └── difficulty-adjustment/ # 可调难度
│   ├── shared/                # 共享资源
│   │   ├── types/             # 类型定义
│   │   ├── utils/             # 工具函数
│   │   └── constants/         # 常量定义
